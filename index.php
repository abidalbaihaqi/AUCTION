          ...
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="row">
              <div class="col-12">
                <div class="mb-4">
                  <h3>Masuk</h3>
                  <p>Tidak mempunyai akun? <a href="daftar_masyarakat.php">Daftar disini</a></p>
                    <hr>
                    <?php 
        if(isset($_GET['info'])){
          if($_GET['info'] == "gagal"){ ?>
          ...
          <?php } } ?>
            ...
            <div class="col-12">
              <div class="d-grid">
                ...
                <a href="login.php" class="btn btn-light btn-lg" >Masuk sebagai Admin/Petugas</a>
              </div>
            </div>
          </div>
        </div>
