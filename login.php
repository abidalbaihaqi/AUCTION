...
<head>
    ...
    <title>Moodah | Masuk Administrator dan Petugas</title>
...
<body>
    ...
    <section style="background-color: #8a2be2;" class="py-3 py-md-5 py-xl-8">
  <div class="container">
    <div class="row gy-4 align-items-center">
      <div class="col-12 col-md-6 col-xl-7">
      <div style="color: #8a2be2;" class="d-flex justify-content-center text-white">
          <div class="col-12 col-xl-9">
            ...
            <h2 class="h1 mb-4">Atur semuanya, Kerja dimana saja. #MoodahBersamaKami</h2>
            <p class="lead mb-5">Membuka lelang, dan Menutup lelang. Dimanapun kapanpun, tentukan pemenangnya!</p>
            <div class="text-endx">
      ...
      <div class="col-12 col-md-6 col-xl-5">
        ...
        if(isset($_GET['info'])){
          ...
          <?php } } ?>
            ...
            <div class="col-12">
              <div class="d-grid">
                <p class="mt-4 mb-4">Jika bukan Admin/Petugas silahkan kembali ke halaman masuk utama</p>
                <a href="index.php" class="btn btn-light btn-lg" >Halaman masuk utama</a>
              </div>
            </div>
          </div>
        </div>
